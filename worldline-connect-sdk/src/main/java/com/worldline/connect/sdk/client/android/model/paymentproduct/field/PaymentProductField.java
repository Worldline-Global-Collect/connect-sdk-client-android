...
import com.worldline.connect.sdk.client.android.formatter.FormatResult;
import com.worldline.connect.sdk.client.android.model.paymentrequest.PaymentRequest;
import com.worldline.connect.sdk.client.android.model.paymentproduct.field.displayhints.DisplayHintsProductFields;
...
public class PaymentProductField implements Serializable {
	 ...
	 * @return {@link FormatResult} that contains the masked String and the new cursor index
	 *
	 * @deprecated the masking behaviour that is provided by {@link #applyMask(String, String, int, int, int)} provides a better user experience.
	 */
	@Deprecated
